    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationCompleted(PhoneAuthCredential credential) {
                ...
                Toast.makeText(getBaseContext(),"Verification Complete",Toast.LENGTH_SHORT).show();
            ...
            public void onCodeSent(String verificationId,
                ...
                Toast.makeText(getBaseContext(),"Verification code has been send on your number",Toast.LENGTH_SHORT).show();
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PhoneAuthProvider.getInstance().verifyPhoneNumber(e1.getText().toString(), 60, java.util.concurrent.TimeUnit.SECONDS,OTPActivity.this, mCallbacks);
            }
        });
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(getBaseContext(),"Verification Done",Toast.LENGTH_SHORT).show();
                            // ...
                        } else {
                            // Log.w(TAG, "signInWithCredential:failure", task.getException());
                            if (task.getException() instanceof FirebaseAuthInvalidCredentialsException) {
                                // The verification code entered was invalid
                                Toast.makeText(getBaseContext(),"Invalid Verification",Toast.LENGTH_SHORT).show();
                            }
                        }
                    }
                });
